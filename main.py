...
def main():
    ...
    for poisoning_rate in [0, 0.12]:
        ...
        pk.dump(baselinemodel.getParams(), open("baselineModel_params_ridge_{}_rvo.params".format(poisoning_rate), "wb"))
        print("Posion points X shape:", data_poison.X.shape)
        print("Posion points Y shape:", data_poison.Y.shape)
        print("Final mse:", mse_after_poisoning)
